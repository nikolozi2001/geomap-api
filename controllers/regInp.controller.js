...
/**
 * Get all regional input data
 * Query parameters: year, month (optional)
 */
exports.getRegInp = async (req, res) => {
  try {
...
/**
 * Get regional input data by region ID
 * Path parameter: region_id
 * Query parameters: year, month (optional)
 */
exports.getRegInpByRegion = async (req, res) => {
  try {
 ...
 */
exports.getRegInpByYearMonth = async (req, res) => {
  try {
    const { year, month } = req.query;
 ...
 */
exports.getRegInpAvailablePeriods = async (req, res) => {
  try {
    const query = `
      SELECT DISTINCT 
        [year],
